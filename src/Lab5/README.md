...
### Давайте так, кто сможет реализовать полноценное asp.net приложение, получит +3 доп.балла.
## Из дополнительных требований:
1 должна быть basic аутентификация
2 в методах контроллеров не должно быть бизнес-логики. Контроллер должен передавать вызов в какой-то фасад/сервисы ядра.
3 в качестве юая используйте Swagger
4 https можно не делать, только http

Еще раз, asp.net это по желанию. Можно сделать только то, что от вас просят в основном задании и получить 20 баллов.
